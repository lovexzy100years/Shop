						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div id="login_from" class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" action="AddressController?action=addAddress&userId=${userId}" method="post">
										<input name="userid" placeholder="用户ID" type="hidden" value="${userId}">
