...
<div class="take-delivery">
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
<%--         ${sessionScope.shopCar.allMoney}--%>


    <c:if test="${empty shopCar}"><li >付款金额<em>¥${sessionScope.temporaryShopCar.allMoney}元</em></li></c:if>
    <c:if test="${not empty shopCar}"><li >付款金额<em>¥${shopCar.allMoney}元</em></li></c:if>
