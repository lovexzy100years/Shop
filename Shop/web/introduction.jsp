			...
			<div class="box">
				<script type="text/javascript">
					$(function () {
						...
						$("#add").click(function () {
							var count = parseInt($("#value").val());
							if(count >= ${goodsInfo.goods_stock}){
								$("#value").val(${goodsInfo.goods_stock})
							}else{
								count++;
								$("#value").val(count)
							}
						...
						$("#LikBasket").click(function () {
							window.location = "ShopController?action=addShopCar&id=${goodsInfo.id}&count="+$("#value").val();
						})

						$("#buy").click(function () {
							window.location = "ShopController?action=initNowPay&userId=${userId}&id=${goodsInfo.id}&count="+$("#value").val();
						})
					})
				</script>

				<div class="tb-booth tb-pic tb-s310">
					<a href="#"><img src="images/${goodsInfo.goods_pic}" style="width: 350px; height: 350px" alt="细节展示放大镜特效" rel="" class="jqzoom" /></a>
				</div>
		...
		<div class="clearfixRight">
			...
			<div class="tb-detail-list">
				...
				<dl class="iteminfo_parameter sys_item_specpara">
					...
					<dd>
						<input id="reduce" class="am-btn am-btn-default" name="" type="button" value="-" />
						<input id="value" name="pic" type="text" value="1" style="width: 30px;" />
						<input id="add" class="am-btn am-btn-default" name="" type="button" value="+" />
						<span id="Stock" class="tb-hidden">库存<span class="stock" id="stock">${goodsInfo.goods_stock}</span>件</span>
					</dd>
